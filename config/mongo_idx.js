...
db.segmentation.createIndex({"provenance.image.slide": 1, "provenance.analysis.execution_id": 1, "footprint":1, "x":1, "y":1})
db.segmentation.createIndex({"provenance.image.slide":1,"provenance.analysis.execution_id":1,"provenance.analysis": 1})
db.segmentation.createIndex({"provenance.image.slide":1,"provenance.analysis": 1})
db.segmentation.createIndex({"provenance.image.slide": 1, "provenance.analysis.execution_id": 1})
db.segmentation.createIndex({"provenance.image.slide": 1, "provenance.analysis.source": 1})
db.segmentation.createIndex({"provenance.image.slide": 1})
db.segmentationMeta.createIndex({'slide':1, 'execution_id':1})
